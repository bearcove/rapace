    ...
    match args.transport {
        TransportType::Stream => {
            ...
            if args.addr.contains(':') {
                // TCP
                eprintln!("[http-plugin] Connecting to TCP address: {}", args.addr);
                ...
                #[cfg(unix)]
                {
                    ...
                    eprintln!("[http-plugin] Connecting to Unix socket: {}", args.addr);
        ...
        TransportType::Shm => {
            ...
            eprintln!("[http-plugin] Opening SHM file: {}", args.addr);
